...
class reposFetcher():
    ...
    def _get_repositories_dict(self):
        ...
        if repositories_list:
            ...
            logging.error(f'error - crucial_object_empty - no repositories metadata at {REPS_URL}. JSON is empty. Exiting ...')
...
class galaxyTool():
    ...
    def _get_metadata(self, repository_dict):
        ...
        if meta:
            ...
            logging.warning(f"error - empty - Metadata for repository {url} not found.")
            return(meta)
